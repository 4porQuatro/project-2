        ...
        <div class="mx-auto max-w-md px-4 sm:max-w-2xl sm:px-6 lg:px-0 lg:py-20 lg:max-w-none">
          <blockquote>
            <div>
              ...
              <p class="mt-6 text-2xl font-medium text-white">{{$data->text->default}}</p>
            </div>
            <footer class="mt-6">
              <p class="text-base font-medium text-white">{{$data->text_name_1->default}}</p>
              @if(!empty($data->text_name_2->default))
                <p class="text-base font-medium text-indigo-100">{{$data->text_name_2->default}}</p>
              @endif
            </footer>
          </blockquote>
        </div>
