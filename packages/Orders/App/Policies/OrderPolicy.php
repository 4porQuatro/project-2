...
class OrderPolicy
{
    ...
    {
        return $user->hasPermission('order_index');
    }
     ...
     *
     * @param  \App\Models\User  $user
     * @param  \Packages\Orders\App\Models\  $order
     * @return mixed
     */
    public function view(User $user, Order $order = null)
    {
        return $user->hasPermission('order_show');
    }
    ...
    {
        return $user->hasPermission('order_store');
    }
    ...
    {
        return $user->hasPermission('order_destroy');
    }
