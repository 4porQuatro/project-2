...
class CountryPolicy
{
    ...
    {
        return $user->hasPermission('country_index');
    }
     ...
     *
     * @param  \App\Models\User  $user
     * @param  \Packages\Country\App\Models\Country  $country
     * @return mixed
     */
    ...
    {
        return $user->hasPermission('country_store');
    }
    ...
    {
        return $user->hasPermission('country_update');
    }
    ...
    {
        return $user->hasPermission('country_destroy');
