...
class AttributePolicy
{
    ...
    {
        return $user->hasPermission('attribute_index');
    }
     ...
     *
     * @param  \App\Models\User  $user
     * @param  \Packages\Store\app\Models\Attribute  $attribute
     * @return mixed
     */
    public function view(User $user, Attribute $attribute)
    {
        return $user->hasPermission('attribute_show');
    }
    ...
    {
        return $user->hasPermission('attribute_store');
    }
    ...
    {
        return $user->hasPermission('attribute_update');
    }
    ...
    {
        return $user->hasPermission('attribute_destroy');
    }
