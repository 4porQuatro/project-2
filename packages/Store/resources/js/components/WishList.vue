...
export default {
    ...
    computed:{
        products(){
            return this.$store.getters['wishlist/content'];
        },

        productsCount(){
            return this.$store.getters['wishlist/content_count'];
        },
    ...
    methods:{
        removeFromCart(product_id){
            ...
            this.$store.dispatch('wishlist/removeProduct', product_id).then(response => {
        ...
        updateProductQuantity(data){
            ...
            this.$store.dispatch('wishlist/updateProductQuantity', data).then(response => {
